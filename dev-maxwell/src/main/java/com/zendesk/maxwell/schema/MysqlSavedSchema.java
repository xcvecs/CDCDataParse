...
public class MysqlSavedSchema {
	...
	//todo
//	public MysqlSavedSchema(DataEventContext context, Schema schema, Position position) throws SQLException {
//		this(1, context.getCaseSensitivity(), schema, position);
//	}
...
//	public static MysqlSavedSchema restore(DataEventContext context, Position targetPosition) throws SQLException, InvalidSchemaError {
