...
import static top.byteinfo.schema.GlobalConstant.SQLResultColumnLabel.*;
...
public class SchemaCapture {
    ...
    private static final Logger log = LoggerFactory.getLogger(SchemaCapture.class.getName());
